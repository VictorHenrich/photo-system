...
DEFAULT_PICTURE_WIDTH_SIZE: str = os.environ.get("DEFAULT_PICTURE_WIDTH_SIZE", "300")

DEFAULT_PICTURE_HEIGHT_SIZE: str = os.environ.get("DEFAULT_PICTURE_HEIGHT_SIZE", "300")
